...
Features:
    ...
    Removes Games for Windows Live (xlive.dll is no longer loaded by the game)
    Makes the game 4GB aware
    Automatically loads FOSE when using Fallout3.exe to start the game
...
Uses xdelta3 redistributed under Apache Public License 2.0
===============================================================
